...
================================
-run_encoding_gui.sh (shell script for temporarily setting environment variables and 
                      executing the application)
   -to run the shell script, type
   
       ./run_encoding_gui.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v98, run the shell script as:
       ...
       ./run_encoding_gui.sh /mathworks/home/application/v98
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_encoding_gui.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
    Note: if end users are unable to download the MATLAB Runtime using the
    instructions in the previous section, include it when building your 
    component by clicking the "Runtime included in package" link in the
    Deployment Tool.
-The Macintosh bundle directory structure encoding_gui.app 
    Note: this can be stored in an archive file with the zip command 
    zip -r encoding_gui.zip encoding_gui.app
    or the tar command 
    tar -cvf encoding_gui.tar encoding_gui.app
-This readme file 
...
${DYLD_LIBRARY_PATH}:MR/v98/runtime/maci64:MR/v98/sys/os/maci64:MR/v98/bin/maci64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_encoding_gui.sh 
